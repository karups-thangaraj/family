    ...
    <div class="main">
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div class="subscribe">
                    ...
                    <h5 class="info-text">
                        New Index <a href="./newindex.php" target="_self">New Index Page</a>
                    </h5>
                </div>
            </div>
        </div>
        <div class="footer">
            <div class="container">
                ...
                <a href="https://infinityfree.net"><img src="https://vpassets.infinityfree.net/welcome2017/logo.png"
                        alt="InfinityFree" height="40px"></a>
            </div>
        </div>
    </div>
